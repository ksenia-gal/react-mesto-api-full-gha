...
const { NODE_ENV, SECRET_DEV_KEY, SECRET_SIGNING_KEY } = require('../utils/constants');
...
const auth = (req, res, next) => {
  ...
  try {
    ...
    payload = jwt.verify(token, NODE_ENV === 'production' ? SECRET_SIGNING_KEY : SECRET_DEV_KEY);
  } catch (err) {
